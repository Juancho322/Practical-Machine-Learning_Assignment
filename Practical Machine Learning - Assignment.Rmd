...
### 6. Conclusion
We fit a random forest model with 6 variables tried at each split and get an accuracy of 0.99 Finally, applying our preferred model to the testing data given in the beginning, we get the following predictions.
```{r message=FALSE}
# The predictive accuracies of the above methods are:
#Classification Tree Model: 49.61 %
#Generalized Boosted Model: 98.97 %       
